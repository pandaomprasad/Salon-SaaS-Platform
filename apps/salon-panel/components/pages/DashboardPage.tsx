...
//                       {s.bookingsToday} bookings today
//                     </p>
//                   </div>
...
//                     <th
//                       key={h}
//                       className="text-left text-xs font-medium text-ash pb-3 pr-6"
//                     >
//                       {h}
//                     </th>
//                   ))}
...
//                   <tr
//                     key={b.id}
//                     className="border-b border-smoke/50 hover:bg-smoke/20 transition-colors"
//                   >
